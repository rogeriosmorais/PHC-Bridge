...
FString FPhysAnimBridgeTraceWriter::BuildFrameCsvRow(const FPhysAnimBridgeTraceFrame& Frame)
{
	...
	AppendCsvField(Fields, Frame.NumNormalPolicyTargetsWritten);
	AppendCsvField(Fields, Frame.NumHeldTargetsWritten);
	AppendCsvField(Fields, Frame.NumTotalTargetsWritten);
