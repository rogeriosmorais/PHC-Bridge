...
void UPhysAnimComponent::ResetStabilizationRuntimeState()
{
	...
	PoseSearchBestIdleAnimationForDiagnostics.Reset();
	PoseSearchBestIdleCostForDiagnostics = -1.0f;
	PoseSearchBestLocomotionAnimationForDiagnostics.Reset();
	PoseSearchBestLocomotionCostForDiagnostics = -1.0f;
	PoseSearchCommandHistoryBestIdleAnimationForDiagnostics.Reset();
	PoseSearchCommandHistoryBestIdleCostForDiagnostics = -1.0f;
	PoseSearchCommandHistoryBestLocomotionAnimationForDiagnostics.Reset();
	PoseSearchCommandHistoryBestLocomotionCostForDiagnostics = -1.0f;
