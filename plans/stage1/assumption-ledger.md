...
|---|---|---|---|---|---|---|---|
| A-01 | PHC motion in training looks convincingly alive | Stage 1 is pointless if the source motion already looks robotic | yellow | G1 training visualization and manual check `MV-G1-01` | motion looks stiff, unstable, or puppet-like in training | narrow to locomotion-only test | yes |
