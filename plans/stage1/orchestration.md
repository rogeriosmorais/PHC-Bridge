...
The user owns the intervention points defined in [user-interventions.md](/F:/NewEngine/plans/stage1/user-interventions.md).
...
- Worker A: `plans/stage1/bridge-spec.md`
- Worker B: `plans/stage1/retargeting-spec.md`
- Worker C: `plans/stage1/test-strategy.md`
...
The orchestrator must maintain [assumption-ledger.md](/F:/NewEngine/plans/stage1/assumption-ledger.md) as a live control document.
...
- orchestrator owns `plans/stage1/assumption-ledger.md`
