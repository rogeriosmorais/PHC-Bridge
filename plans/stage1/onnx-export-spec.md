...
- [dependency-lock.md](/F:/NewEngine/plans/stage1/dependency-lock.md)
...
1. record the replacement path in [dependency-lock.md](/F:/NewEngine/plans/stage1/dependency-lock.md)
...
4. record the first accepted opset in [dependency-lock.md](/F:/NewEngine/plans/stage1/dependency-lock.md)
