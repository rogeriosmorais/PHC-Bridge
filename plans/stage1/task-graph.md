...
| S1-P0-A1 | Phase 0 | AI | Prepare feasibility execution package for ProtoMotions, UE5 control-path checks, and G1 evidence capture | S1-PLAN-02, S1-PLAN-03, S1-PLAN-04, S1-P0-U2 | implementation-ready command and validation package | No |
