...
| S1-PLAN-02 | Planning | AI | Produce the PHC bridge spec | S1-PLAN-01 | `plans/stage1/10-specs/bridge-spec.md` | Only if the PHC contract changes Stage 1 scope |
| S1-PLAN-03 | Planning | AI | Produce the SMPL <-> UE5 retargeting spec | S1-PLAN-01 | `plans/stage1/10-specs/retargeting-spec.md` | Only if bone mapping policy needs approval |
| S1-PLAN-04 | Planning | AI | Produce the Stage 1 test strategy | S1-PLAN-01 | `plans/stage1/10-specs/test-strategy.md` | Only if a critical claim cannot be automated |
| S1-PLAN-05 | Planning | Orchestrator | Maintain the live assumption and failure ledger | S1-PLAN-02, S1-PLAN-03, S1-PLAN-04 | `plans/stage1/20-execution/assumption-ledger.md` | Only if a user decision is required to resolve a red assumption |
