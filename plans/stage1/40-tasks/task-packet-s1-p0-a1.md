...
Use it only after the user has returned the prerequisite setup evidence described in [user-interventions.md](/F:/NewEngine/plans/stage1/60-user/user-interventions.md).
...
- [pretrained-model-selection.md](/F:/NewEngine/plans/stage1/50-content/pretrained-model-selection.md)
- [pretrained-checkpoint-retrieval.md](/F:/NewEngine/plans/stage1/50-content/pretrained-checkpoint-retrieval.md)
- [environment-spec.md](/F:/NewEngine/plans/stage1/10-specs/environment-spec.md)
- [motion-source-map.md](/F:/NewEngine/plans/stage1/50-content/motion-source-map.md)
- [ue-project-scaffold.md](/F:/NewEngine/plans/stage1/50-content/ue-project-scaffold.md)
- [acceptance-thresholds.md](/F:/NewEngine/plans/stage1/10-specs/acceptance-thresholds.md)
- the latest user setup evidence

## Writable Paths

- [phase0-execution-package.md](/F:/NewEngine/plans/stage1/20-execution/phase0-execution-package.md)
- [bridge-spec.md](/F:/NewEngine/plans/stage1/10-specs/bridge-spec.md)
- [retargeting-spec.md](/F:/NewEngine/plans/stage1/10-specs/retargeting-spec.md)
...
- static review against [phase0-execution-package.md](/F:/NewEngine/plans/stage1/20-execution/phase0-execution-package.md)
- consistency review against [acceptance-thresholds.md](/F:/NewEngine/plans/stage1/10-specs/acceptance-thresholds.md)
