...
When real machine values are known, copy them into [dependency-lock.md](/F:/NewEngine/plans/stage1/10-specs/dependency-lock.md).
...
3. record the final choice in [dependency-lock.md](/F:/NewEngine/plans/stage1/10-specs/dependency-lock.md)
