...
- escalate to the user when a blocker falls under `plans/stage1/60-user/user-interventions.md`
...
- `Output`: `plans/stage1/40-tasks/task-graph.md`, `plans/stage1/00-control/delegation-spec.md`, `plans/stage1/00-control/handoff-format.md`, `plans/stage1/60-user/user-interventions.md`, `plans/stage1/60-user/manual-verification.md`
...
- `Output`: `plans/stage1/10-specs/bridge-spec.md`
...
- `Output`: `plans/stage1/10-specs/retargeting-spec.md`
...
- `Inputs`: `ENGINEERING_PLAN.md`, workflow docs, `plans/stage1/60-user/manual-verification.md`
- `Work`: decide what must be TDD, what waits for UE5 automation, and what remains human-evaluated
- `Output`: `plans/stage1/10-specs/test-strategy.md`
...
- `Output`: `plans/stage1/20-execution/phase0-execution-package.md`
...
- `Output`: `plans/stage1/30-evidence/g1-evidence.md`
...
- `Output`: `plans/stage1/20-execution/phase1-implementation-package.md`
...
- `Output`: `plans/stage1/40-tasks/task-packet-s1-p1-a2.md`, `plans/stage1/60-user/manual-verification.md`, `plans/stage1/10-specs/acceptance-thresholds.md`, `plans/stage1/30-evidence/g2-evaluation.md`, `plans/stage1/20-execution/execution-log.md`
...
- `Output`: `plans/stage1/20-execution/phase2-demo-package.md`
...
- `Output`: `plans/stage1/30-evidence/g3-evaluation.md`
