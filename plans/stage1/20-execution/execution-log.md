...
```text
execute S2-CLEANUP-PROOF-INFRASTRUCTURE-01 only
```
...
|---|---|---|---|
| 1 | `S2-CLEANUP-PROOF-INFRASTRUCTURE-01` | `plans/stage1/20-execution/task-packets/S2-CLEANUP-PROOF-INFRASTRUCTURE-01.md` | Cleanup proof infrastructure and close bypass. |
