...
| Last Scope | `PASSED` |
| Workflow Note | `Idle after pivot proof; active shell and proof-routing regressions are green.` |
...
```text
Idle after pivot proof; active shell and proof-routing regressions are green.
```
