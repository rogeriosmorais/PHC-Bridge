...
| Field | Value |
|---|---|
| Current Task ID | `S2-PROOF-ACTIVATED-STANDING-LOCOMOTION-ACTIVE-SHELL-PIVOT-01` |
| Current Task Packet | `plans/stage1/20-execution/task-packets/S2-PROOF-ACTIVATED-STANDING-LOCOMOTION-ACTIVE-SHELL-PIVOT-01.md` |
...
| Latest Technical Head | `edeb6b3907468f49c1d63d7046a5c7072a449e1d` |
| Last Build | `SUCCESS` |
| Last Test | `PhysAnim.ActivationReview.ProofFailureFailStopRouting: PASS; PhysAnim.RuntimeTermination.Pipeline: PASS; PhysAnim.ActivationPath.Wiring: PASS; PhysAnim.ActivationReview.ProofSatisfiedProxyHandoffSourceOfTruthProof: PASS; PhysAnim.ActivationReview.ProofSatisfiedProxyHandoffSourceOfTruth: PASS; PhysAnim.StandingProof.Live: PASS; PhysAnim.StandingProof.NegativeSupport: PASS` |
| Last Scope | `PASSED` |
| Workflow Note | `Runnable pivot proof: verify locomotion active shell after proof-routing repairs.` |
...
```text
execute S2-PROOF-ACTIVATED-STANDING-LOCOMOTION-ACTIVE-SHELL-PIVOT-01 only
```
...
|---|---|---|---|
| 1 | `S2-PROOF-ACTIVATED-STANDING-LOCOMOTION-ACTIVE-SHELL-PIVOT-01` | `plans/stage1/20-execution/task-packets/S2-PROOF-ACTIVATED-STANDING-LOCOMOTION-ACTIVE-SHELL-PIVOT-01.md` | Current runnable task. |
