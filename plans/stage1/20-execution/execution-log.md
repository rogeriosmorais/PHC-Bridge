...
| Workflow Note | `Plant contract runtime adapter snapshot capture is green. No next explicit task packet is runnable.` |
...
Reason: Plant contract runtime adapter snapshot capture is green. No next explicit task packet is runnable.
