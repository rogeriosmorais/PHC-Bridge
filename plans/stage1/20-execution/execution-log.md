...
`	ext
execute S2-PROOF-EDITOR-STANDING-ATTEMPT-01 only
`
"@
...
| Priority | Task ID | Packet | Notes |
|---|---|---|---|
| 1 | `S2-PROOF-EVIDENCE-CAPTURE-PREP-01` | `plans/stage1/20-execution/task-packets/S2-PROOF-EVIDENCE-CAPTURE-PREP-01.md` | Prepare evidence extraction checklist. |
| 2 | `S2-PROOF-EDITOR-STANDING-ATTEMPT-01` | `plans/stage1/20-execution/task-packets/S2-PROOF-EDITOR-STANDING-ATTEMPT-01.md` | Execute live standing proof in UE5 Editor. |
...
| Runtime artifact emission | blocked | blocked until live evidence proof is green |
