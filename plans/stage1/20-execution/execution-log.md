...
| Last Scope | `PASSED` |
| Workflow Note | `Activated standing perturbation proof complete; next task is activated standing perturbation recovery tuning.` |
...
`	ext
execute S2-TUNE-ACTIVATED-STANDING-PERTURBATION-RECOVERY-01 only
`
"@
