...
```text
execute S2-IMPL-RUNTIME-TERMINATION-COMMAND-01 only
```
...
|---|---|---|---|
| 1 | `S2-IMPL-RUNTIME-TERMINATION-COMMAND-01` | `plans/stage1/20-execution/task-packets/S2-IMPL-RUNTIME-TERMINATION-COMMAND-01.md` | Convert orchestrator result into a deterministic runtime termination command without mutating live components. |
