...
| Field | Value |
|---|---|
| Current Task ID | `S2-IMPL-POLICY-ACTION-OUTPUT-DESCRIPTOR-CONTRACT-01` |
| Current Task Packet | `plans/stage1/20-execution/task-packets/S2-IMPL-POLICY-ACTION-OUTPUT-DESCRIPTOR-CONTRACT-01.md` |
...
| Latest Technical Head | `d531215fbca007c6752569e36efaa7bb98206766` |
| Last Build | `SUCCESS` |
| Last Test | `PhysAnim.Bridge.ActionConditioningContract: PASS; PhysAnim.Bridge.ActionToBoneMappingContract: PASS; PhysAnim.Bridge.ControlTargetStepLimitContract: PASS; PhysAnim.ActivatedStanding.LocomotionActiveShell: PASS` |
| Last Scope | `PASSED` |
| Workflow Note | `Runnable policy action output descriptor contract task.` |
...
```text
execute S2-IMPL-POLICY-ACTION-OUTPUT-DESCRIPTOR-CONTRACT-01 only
```
...
|---|---|---|---|
| 1 | `S2-IMPL-POLICY-ACTION-OUTPUT-DESCRIPTOR-CONTRACT-01` | `plans/stage1/20-execution/task-packets/S2-IMPL-POLICY-ACTION-OUTPUT-DESCRIPTOR-CONTRACT-01.md` | Current runnable task. |
