...
```text
execute S2-IMPL-RUNTIME-ADAPTER-SUPPORT-CONTACTS-01 only
```
...
|---|---|---|---|
| 1 | `S2-IMPL-RUNTIME-ADAPTER-SUPPORT-CONTACTS-01` | `plans/stage1/20-execution/task-packets/S2-IMPL-RUNTIME-ADAPTER-SUPPORT-CONTACTS-01.md` | Convert contact samples into support snapshots using SupportTruth. |
