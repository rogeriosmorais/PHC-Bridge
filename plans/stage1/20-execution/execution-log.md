...
| Field | Value |
|---|---|
| Current Task ID | `S2-MEASURE-ACTIVATED-STANDING-STABILITY-01` |
| Current Task Packet | `plans/stage1/20-execution/task-packets/S2-MEASURE-ACTIVATED-STANDING-STABILITY-01.md` |
...
| Last Scope | `PASSED` |
| Workflow Note | `Activation proof baseline locked; next step is activated standing stability measurement.` |
...
```text
S2-MEASURE-ACTIVATED-STANDING-STABILITY-01
```
...
|---|---|---|---|
| 1 | `S2-MEASURE-ACTIVATED-STANDING-STABILITY-01` | `plans/stage1/20-execution/task-packets/S2-MEASURE-ACTIVATED-STANDING-STABILITY-01.md` | Activated standing stability measurement is the next runnable task. |
