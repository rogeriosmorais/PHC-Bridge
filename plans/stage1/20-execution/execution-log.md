...
| Field | Value |
|---|---|
| Current Task ID | `S2-IMPL-POLICY-ACTION-CONTROL-TARGET-CONTRACT-01` |
| Current Task Packet | `plans/stage1/20-execution/task-packets/S2-IMPL-POLICY-ACTION-CONTROL-TARGET-CONTRACT-01.md` |
...
| Latest Technical Head | `c8b1dd38862d65bfd19919e8dec60a864cba6c05` |
| Last Build | `SUCCESS` |
| Last Test | `PhysAnim.ActivatedStanding.LocomotionActiveShell: PASS; PhysAnim.ActivationReview.ProofFailureFailStopRouting: PASS; PhysAnim.RuntimeTermination.Pipeline: PASS; PhysAnim.ActivationPath.Wiring: PASS; PhysAnim.StandingProof.Live: PASS; PhysAnim.StandingProof.NegativeSupport: PASS` |
| Last Scope | `PASSED` |
| Workflow Note | `Runnable bridge policy-action control-target contract task.` |
...
```text
execute S2-IMPL-POLICY-ACTION-CONTROL-TARGET-CONTRACT-01 only
```
...
|---|---|---|---|
| 1 | `S2-IMPL-POLICY-ACTION-CONTROL-TARGET-CONTRACT-01` | `plans/stage1/20-execution/task-packets/S2-IMPL-POLICY-ACTION-CONTROL-TARGET-CONTRACT-01.md` | Current runnable task. |
