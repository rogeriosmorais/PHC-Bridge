...
| Latest Technical Head | `6c009f44bec0cde6d31d803418bf908d32080f52` |
| Last Build | `SUCCESS` |
| Last Test | `PhysAnim.ActivatedStanding.StabilityMetrics: PASS` |
| Last Scope | `PASSED` |
| Workflow Note | `Activated standing stability measurement complete; awaiting next packet.` |
...
```text
Activated standing stability measurement complete; awaiting next packet.
```
