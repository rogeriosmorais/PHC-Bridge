...
```text
execute S2-IMPL-RUNTIME-TERMINATION-STATE-APPLIER-01 only
```
...
|---|---|---|---|
| 1 | `S2-IMPL-RUNTIME-TERMINATION-STATE-APPLIER-01` | `plans/stage1/20-execution/task-packets/S2-IMPL-RUNTIME-TERMINATION-STATE-APPLIER-01.md` | Apply a termination command to deterministic component-owned runtime state without touching live UE components. |
