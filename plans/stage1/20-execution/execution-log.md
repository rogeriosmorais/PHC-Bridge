...
`	ext
execute S2-PROOF-ACTIVATED-STANDING-LOCOMOTION-READINESS-01 only
`
"@
...
| Priority | Task ID | Packet | Notes |
|---|---|---|---|
| none | none | none | No task is currently runnable. |
