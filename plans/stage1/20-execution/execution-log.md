...
```text
S2-PROOF-ACTIVATED-STANDING-PERTURBATION-01
```
...
|---|---|---|---|
| 1 | `S2-PROOF-ACTIVATED-STANDING-PERTURBATION-01` | `plans/stage1/20-execution/task-packets/S2-PROOF-ACTIVATED-STANDING-PERTURBATION-01.md` | Proof-only activated standing perturbation validation is the next runnable task. |
