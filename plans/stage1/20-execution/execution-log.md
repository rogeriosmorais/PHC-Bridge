...
```text
execute S2-IMPL-RUNTIME-TERMINATION-PIPELINE-01 only
```
...
|---|---|---|---|
| 1 | `S2-IMPL-RUNTIME-TERMINATION-PIPELINE-01` | `plans/stage1/20-execution/task-packets/S2-IMPL-RUNTIME-TERMINATION-PIPELINE-01.md` | Compose orchestrator, command builder, and state applier into one deterministic termination pipeline call. |

## Blocked / Deferred

| Item | Status | Reason |
|---|---|---|
| Runtime component mutation | blocked | blocked until deterministic termination command contract is green |
| Runtime state-machine rewrite | blocked | blocked until termination command contract and component mutation seam are green |
| Runtime artifact emission | blocked | blocked until termination command contract is green |
