...
| Field | Value |
|---|---|
| Current Task ID | `S2-IMPL-RUNTIME-ADAPTER-PLANT-01` |
| Current Task Packet | `plans/stage1/20-execution/task-packets/S2-IMPL-RUNTIME-ADAPTER-PLANT-01.md` |
...
| Latest Technical Head | `ea1350b824501c2004c27b7684477e1dbcece975` |
| Last Build | `passed: .\scripts\build.ps1` |
| Last Test | `not applicable: S2-IMPL-RUNTIME-ADAPTER-CAPSULE-01` |
| Last Scope | `passed: check_task_scope.ps1 for S2-IMPL-RUNTIME-ADAPTER-CAPSULE-01` |
| Workflow Note | `Plant contract runtime adapter snapshot capture is selected as the next packet.` |
| Working Tree Requirement | `clean before starting a task` |

## Next Action
Run `go` for `S2-IMPL-RUNTIME-ADAPTER-PLANT-01`.

## Next Runnable Tasks

| Priority | Task ID | Packet | Notes |
|---|---|---|---|
| 1 | `S2-IMPL-RUNTIME-ADAPTER-PLANT-01` | `plans/stage1/20-execution/task-packets/S2-IMPL-RUNTIME-ADAPTER-PLANT-01.md` | Add plant contract runtime adapter snapshot capture. |
