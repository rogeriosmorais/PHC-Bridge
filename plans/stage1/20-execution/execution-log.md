...
| Last Scope | `PASSED` |
| Workflow Note | `Live policy activity instrumentation committed; strict live-balance assertions remain opt-in until raw-sim body contract is implemented.` |
...
```text
Live policy activity instrumentation committed; strict live-balance assertions remain opt-in until raw-sim body contract is implemented.
```
