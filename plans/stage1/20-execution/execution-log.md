...
```text
execute S2-FIX-P1A-PROOF-DISABLED-SAFE-DENY-01 only
```
...
|---|---|---|---|
| 1 | `S2-FIX-P1A-PROOF-DISABLED-SAFE-DENY-01` | `plans/stage1/20-execution/task-packets/S2-FIX-P1A-PROOF-DISABLED-SAFE-DENY-01.md` | Current runnable task. |
