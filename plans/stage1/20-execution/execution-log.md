...
```text
execute S2-IMPL-RUNTIME-ADAPTER-SUPPORT-01 only
```
...
|---|---|---|---|
| 1 | `S2-IMPL-RUNTIME-ADAPTER-SUPPORT-01` | `plans/stage1/20-execution/task-packets/S2-IMPL-RUNTIME-ADAPTER-SUPPORT-01.md` | Capture runtime support snapshot inputs from UE data. |
