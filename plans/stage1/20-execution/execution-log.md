...
| Field | Value |
|---|---|
| Current Task ID | `S2-IMPL-ACTIVATED-STANDING-LOCOMOTION-ACTIVE-SHELL-01` |
| Current Task Packet | `plans/stage1/20-execution/task-packets/S2-IMPL-ACTIVATED-STANDING-LOCOMOTION-ACTIVE-SHELL-01.md` |
...
| Last Scope | `PASSED` |
| Workflow Note | `Activated standing locomotion active shell runnable.` |
...
```text
Activated standing locomotion active shell runnable.
```
