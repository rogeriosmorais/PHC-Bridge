...
| Last Scope | `PASSED` |
| Workflow Note | `Raw-sim body-group bisect completed; catastrophic energy spike isolated to full required body set while smaller groups also trip support denial.` |
...
```text
Raw-sim body-group bisect completed; catastrophic energy spike isolated to full required body set while smaller groups also trip support denial.
```
