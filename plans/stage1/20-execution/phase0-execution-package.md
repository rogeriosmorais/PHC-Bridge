...
The fastest way to resume this package after user setup work is to gather evidence with [user-return-template.md](/F:/NewEngine/plans/stage1/60-user/user-return-template.md) and then issue [task-packet-s1-p0-a1.md](/F:/NewEngine/plans/stage1/40-tasks/task-packet-s1-p0-a1.md).

## Entry Criteria

Do not start Phase 0 until all of these are true:

- [bridge-spec.md](/F:/NewEngine/plans/stage1/10-specs/bridge-spec.md) exists
- [retargeting-spec.md](/F:/NewEngine/plans/stage1/10-specs/retargeting-spec.md) exists
- [test-strategy.md](/F:/NewEngine/plans/stage1/10-specs/test-strategy.md) exists
- [assumption-ledger.md](/F:/NewEngine/plans/stage1/20-execution/assumption-ledger.md) has been reviewed by the orchestrator for Phase 0
- [acceptance-thresholds.md](/F:/NewEngine/plans/stage1/10-specs/acceptance-thresholds.md) exists
- [pretrained-checkpoint-retrieval.md](/F:/NewEngine/plans/stage1/50-content/pretrained-checkpoint-retrieval.md) exists
...
3. Motion-source review against [motion-set.md](/F:/NewEngine/plans/stage1/50-content/motion-set.md)
4. Checkpoint retrieval recorded in [dependency-lock.md](/F:/NewEngine/plans/stage1/10-specs/dependency-lock.md)
5. A completed [g1-evidence.md](/F:/NewEngine/plans/stage1/30-evidence/g1-evidence.md) package
...
- Inputs:
  ...
  - `plans/stage1/10-specs/bridge-spec.md`
- Output:
  - updated `plans/stage1/10-specs/bridge-spec.md`
...
- Output:
  - updated `plans/stage1/10-specs/retargeting-spec.md`
...
- threshold checks from [acceptance-thresholds.md](/F:/NewEngine/plans/stage1/10-specs/acceptance-thresholds.md)
...
Use [handoff-format.md](/F:/NewEngine/plans/stage1/00-control/handoff-format.md) exactly.
