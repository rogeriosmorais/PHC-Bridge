...
|---|---|---|---|---|
| S1-U-01 | Before Phase 0 execution | Install external tools and confirm paths (`conda`, UE5, any required SDK/runtime pieces) | installation happens outside the repo and may require local machine choices | version list and resolved paths |
