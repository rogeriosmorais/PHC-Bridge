...
For the detailed step-by-step version, use [user-runbook.md](/F:/NewEngine/plans/stage1/60-user/user-runbook.md).
...
When the user returns with setup progress, use [user-return-template.md](/F:/NewEngine/plans/stage1/60-user/user-return-template.md) so the orchestrator can resume without guessing.
...
For the initial Unreal project creation step, use [eli5-ue-project-setup.md](/F:/NewEngine/plans/stage1/60-user/eli5-ue-project-setup.md).

For the Phase 1 editor asset wiring and bridge startup path, use [phase1-ue-bridge-bringup-runbook.md](/F:/NewEngine/plans/stage1/20-execution/phase1-ue-bridge-bringup-runbook.md).

For the full user-owned workflow across Phase 0, Phase 1, and Phase 2, use [user-runbook.md](/F:/NewEngine/plans/stage1/60-user/user-runbook.md).
