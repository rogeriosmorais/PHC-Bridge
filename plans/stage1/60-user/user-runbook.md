...
For the detailed Phase 1 editor bring-up path for the new component-based bridge, use [phase1-ue-bridge-bringup-runbook.md](/F:/NewEngine/plans/stage1/20-execution/phase1-ue-bridge-bringup-runbook.md).
...
Use [eli5-ue-project-setup.md](/F:/NewEngine/plans/stage1/60-user/eli5-ue-project-setup.md) for the click-by-click path.
...
Run [manual-verification.md](/F:/NewEngine/plans/stage1/60-user/manual-verification.md) exactly.

Short version:

1. Open PowerShell in `F:\NewEngine\Training\ProtoMotions`.
2. Run the `phase0_eval_visual` command from [manual-verification.md](/F:/NewEngine/plans/stage1/60-user/manual-verification.md#L21).
...
- [manual-verification.md](/F:/NewEngine/plans/stage1/60-user/manual-verification.md#L64)
- [g2-evaluation.md](/F:/NewEngine/plans/stage1/30-evidence/g2-evaluation.md)
...
- [manual-verification.md](/F:/NewEngine/plans/stage1/60-user/manual-verification.md#L75)
- [g3-evaluation.md](/F:/NewEngine/plans/stage1/30-evidence/g3-evaluation.md)
