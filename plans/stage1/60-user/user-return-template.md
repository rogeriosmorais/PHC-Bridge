...
After the user sends this back, transfer the confirmed values into [dependency-lock.md](/F:/NewEngine/plans/stage1/10-specs/dependency-lock.md).

For the detailed user-side workflow, use [user-runbook.md](/F:/NewEngine/plans/stage1/60-user/user-runbook.md).
